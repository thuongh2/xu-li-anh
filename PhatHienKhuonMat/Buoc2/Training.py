...
def main(): 
  ...
  detector = cv2.FaceDetectorYN.create(
    "./PhatHienKhuonMat/model/face_detection_yunet_2022mar.onnx",
    "",
    (320, 320),
    0.9,
    0.3,
  ...
  recognizer = cv2.FaceRecognizerSF.create(
            "./PhatHienKhuonMat/model/face_recognition_sface_2021dec.onnx","")
  metadata = load_metadata('./PhatHienKhuonMat/image')
...
# Numerical encoding of identities
  ...
  joblib.dump(svc,'./PhatHienKhuonMat/model/svc.pkl')
